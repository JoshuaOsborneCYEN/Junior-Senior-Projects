...
EXECUTING:
	To compile and run the program, simply g++ the code TechShellFinal.c. The makefile is set up so using the command "make" will compile the file, producing an executable named "techShell".
